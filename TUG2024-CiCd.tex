...
To resolve and make the \acro{PDF} easier to access on GitHub it's required to use additional actions.
...
In this case, we expect the repository to contain a package and some kind of \command{l3build} configuration.\footnote{also works with other tools, but have to focus}
