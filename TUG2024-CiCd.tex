...
\meta{ci-type}\file{\_}\meta{task} adding \enquote{\file{\_minimal}} if the example is not using a pre-packaged Docker Image but includes methods to install packages based on a dependency file as described in \ref{sec:minimize}. –
