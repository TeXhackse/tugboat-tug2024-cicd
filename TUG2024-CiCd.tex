...
This is espcially useful to test if there are any issues with some package update before updating a machine, e.\,g., installing the latest MikTeX updates or where downgrading may be complicated.\footnote{That's another issue to address … but a different story.}
