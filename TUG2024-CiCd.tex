...
Both a private and a public repository works equally well.
...
We are going to elaborate on two variants: Using a full container image (this section) and a minimal installation (Sect.~\ref{sec:min}).
