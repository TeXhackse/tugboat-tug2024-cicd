...
% Source: n/a. This exists only in this repository.
%\begin{listing}
...
% We do not have a public source for that - we should remove the line numbers?
% However, this gets added via https://github.com/islandoftex/tug2024-workflow-document-github/pull/1
% Then, it starts at line 18
...
% This is a streamlined variant of https://gitlab.com/islandoftex/texmf/tug2024-workflow-document-gitlab/-/blob/main/.gitlab-ci.yml?ref_type=heads
